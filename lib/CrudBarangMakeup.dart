...
class CrudBarangMakeup extends StatelessWidget {
  const CrudBarangMakeup({super.key});
  @override
      ...
      body: Column(
        ...
        children: [
          Container(
            ...
            child: Padding(
              padding: EdgeInsets.fromLTRB(16, 30, 16, 99),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.start,
                crossAxisAlignment: CrossAxisAlignment.center,
                mainAxisSize: MainAxisSize.max,
                    ...
                    children: [
                      Stack(
                        ...
                        children: [
                          ...
                          Image(
                            image:
                                AssetImage("lib/assets/images/skintint.jpeg"),
                            height: MediaQuery.of(context).size.height * 0.2,
                            width: MediaQuery.of(context).size.width,
                            fit: BoxFit.cover,
                          ),
                      ...
                      Stack(
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Image(
                              image:
                                  AssetImage("lib/assets/images/eyebrow.jpeg"),
                              height: MediaQuery.of(context).size.height * 0.2,
                              width: MediaQuery.of(context).size.width,
                              fit: BoxFit.cover,
                            ),
                      ...
                      Stack(
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Image(
                              image:
                                  AssetImage("lib/assets/images/bundle4.jpg"),
                              height: MediaQuery.of(context).size.height * 0.2,
                              width: MediaQuery.of(context).size.width,
                              fit: BoxFit.cover,
                            ),
